...
const handleSignUp = async (e: React.FormEvent) => {
  ...
  try {
    console.log("🔹 Call supabase.auth.signUp");
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-32">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSignUp}>
              ...
              {error && (
                <div className="text-center text-sm text-red-600 pb-5">{error}</div>
              )}
              <div className="mb-5">
                <button
                  type="submit"
